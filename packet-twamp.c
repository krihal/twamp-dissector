...
void proto_register_twamp(void)
{
	...
	static hf_register_info hf_twamp[] = {
		...
		{&twamp_t2_integer,
		 {"Timestamp, integer part", "twamp.t2_integer", FT_UINT32,
		  BASE_DEC_HEX, NULL, 0x0, NULL, HFILL}},
		{&twamp_t2_fractional,
		 {"Timestamp, fractional part", "twamp.t2_fractional",
		  FT_UINT32, BASE_DEC_HEX, NULL, 0x0, NULL, HFILL}},
		{&twamp_error_estimate,
		 {"Error Estimate", "twamp.error_estimate", FT_UINT16,
		  BASE_DEC_HEX, NULL, 0x0, NULL, HFILL}},
		{&twamp_mbz1,
		 {"MBZ", "twamp.mbz1", FT_UINT8, BASE_DEC_HEX,
		  NULL, 0x0, NULL, HFILL}},
		{&twamp_t1_integer,
		 {"Receive Timestamp, integer part", "twamp.t1_integer", FT_UINT32,
		  BASE_DEC_HEX, NULL, 0x0, NULL, HFILL}},
		{&twamp_t1_fractional,
		 {"Receive Timestamp, fractional part", "twamp.t1_fractional",
		  FT_UINT32, BASE_DEC_HEX, NULL, 0x0, NULL, HFILL}},
		{&twamp_sender_seq_number,
		 {"Sender Sequence Number", "twamp.sender_seq_number",
		  FT_UINT32, BASE_DEC_HEX, NULL, 0x0, NULL, HFILL}},
		{&twamp_t0_integer,
		 {"Sender Timestamp, integer part", "twamp.t0_integer", FT_UINT32,
		  BASE_DEC_HEX, NULL, 0x0, NULL, HFILL}},
		{&twamp_t0_fractional,
		 {"Sender Timestamp, fractional part", "twamp.t0_fractional",
		  FT_UINT32, BASE_DEC_HEX, NULL, 0x0, NULL, HFILL}},
		{&twamp_sender_error_estimate,
		 {"Sender Error Estimate", "twamp.sender_error_estimate",
		  FT_UINT16, BASE_DEC_HEX, NULL, 0x0, NULL, HFILL}},
		{&twamp_mbz2,
		 {"MBZ", "twamp.mbz2", FT_UINT8, BASE_DEC_HEX,
		  NULL, 0x0, NULL, HFILL}},
		{&twamp_sender_ttl,
